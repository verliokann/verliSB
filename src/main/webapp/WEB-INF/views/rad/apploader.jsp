    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand"
               href="#"><span>${login}, добро пожаловать в систему [наименование системы] </span></a>
        </div>
        ...
        <div class="row">
            ...
            <c:forEach var="role" items="${rolelist}">
                ...
                <c:if test="${role == 'ROLE_ADMIN'}">
                    <div class="col-md-<fmt:formatNumber type="number" maxFractionDigits="0" value="${12/ncol}" />">
                        <a class="btn btn-primary" href="/qps/app_admin">Открыть</a>
                        <h3 class="text-center">РМ "Администратор"</h3>
                        <p>Управление учетными записями пользователей</p>
                    </div>

                    <div class="col-md-<fmt:formatNumber type="number" maxFractionDigits="0" value="${12/ncol}" />">
                        <a class="btn btn-primary" href="/qps/map">Открыть</a>
...
<div class="navbar navbar-default navbar-fixed-bottom navbar-inverse">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand"
               href="#"><span>Кафедра "ВСТ" ИРИТ , &nbsp;НГТУ &nbsp;Н. Новгород &nbsp;2016&nbsp;</span></a>
        </div>
        <div class="collapse navbar-collapse" id="navbar-ex-collapse">
            <ul class="nav navbar-nav navbar-right">
                <li>
