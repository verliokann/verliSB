...
<head>
    ...
    <script data-main="<c:url value="/resources/app_admin/configs/config"/>"
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
            ...
            <form class="navbar-form navbar-left">
                <a href="#" id="rolemode" class="btn btn-default"
                   onclick="ZUI.refreshModal('roleedtform','useredtform','groupedtform'); ZUI.refreshModal('roledeleteform','userdeleteform','groupdeleteform');">Роли
                    пользователей</a>
                <a href="#" id="groupmode" class="btn btn-default"
                   onclick="ZUI.refreshModal('groupedtform','roleedtform','useredtform'); ZUI.refreshModal('groupdeleteform','roledeleteform','userdeleteform')">Группы
                    пользователей</a>
            ...
            <form class="navbar-form navbar-left">
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="divider"></li>
                        <li><a href="/qps/report">Список пользователей</a></li>
                        <li class="divider"></li>
            ...
            <form class="navbar-form navbar-right">
                <a href="/qps/" class="btn btn-default">Мои приложения</a>
